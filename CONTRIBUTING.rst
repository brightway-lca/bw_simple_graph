...
Welcome to ``bw_simple_graph`` contributor's guide.
...
If you experience bugs or general issues with ``bw_simple_graph``, please have a look
...
You can help improve ``bw_simple_graph`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``bw_simple_graph`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``bw_simple_graph``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n bw_simple_graph python=3 six virtualenv pytest pytest-cov
    conda activate bw_simple_graph
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/bw_simple_graph.git
    cd bw_simple_graph
...
#. Install |pre-commit|_::
   ...
   ``bw_simple_graph`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/bw_simple_graph
.. _issue tracker: https://github.com/<USERNAME>/bw_simple_graph/issues
.. <-- end -->
